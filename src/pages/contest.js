...
function Contest() {
  ...
  const rating_deviation = 350; // Set the rating deviation to a constant value

  const player1 = ranking.makePlayer(user1_score, rating_deviation);
  const player2 = ranking.makePlayer(user2_score, rating_deviation);
  var matches = [];
...
//   const pending = false;
//   const user1 = "User1";
//   const user1_score = 1500;
//   const user2 = "User2";
//   const user2_score = 1500;
